    ...
    <div className="w-full h-auto flex flex-col items-center justify-center ">
      ...
      <section className="w-full my-6">
        <div className="w-full flex items-center justify-between">
          ...
          ประชาสัมพันธ์การเฝ้าระวังการควบคุมโรค
          </p>

          <div className="hidden md:flex gap-3 items-center">
            <motion.div
              whileTap={{ scale: 0.75 }}
              className="w-8 h-8 rounded-lg bg-blue-400 hover:bg-blue-500 cursor-pointer  hover:shadow-lg flex items-center justify-center"
            ...
            <motion.div
              whileTap={{ scale: 0.75 }}
              className="w-8 h-8 rounded-lg bg-blue-400 hover:bg-blue-500 cursor-pointer transition-all duration-100 ease-in-out hover:shadow-lg flex items-center justify-center"
              onClick={() => setScrollValue(200)}
            >
      ...
      <section className="w-full my-6">
        ...
        <RowContainer
          scrollValue={scrollValue}
          flag={true}
          data={Items?.filter((n) => n.category === "สามัญประจําบ้าน")}
        />
      </section>
